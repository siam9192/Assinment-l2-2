...
const getSingelProductById = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const result =
        yield product_service_1.default.getSingelProductById(productId);
      res.status(200).json({
        success: true,
...
const updateSingelProductById = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const productId = req.params.productId;
      const data = req.body;
      const result = yield product_service_1.default.updateSingelProductById(
        productId,
        data,
      );
      console.log(result);
...
const deleteSingleProductById = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const productId = req.params.productId;
      const result =
...
const searchProductByText = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const text = req.query.searchTerm;
