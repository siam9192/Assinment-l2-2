...
const updateSingelProductById = async (id: string,updateData:any):Promise<Product|null>=>{
  const result =  await productModel.updateOne({_id : new mongoose.Types.ObjectId(id)},updateData)
